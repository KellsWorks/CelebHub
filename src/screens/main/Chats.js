...
import {TouchableHighlight, ImageBackground, ScrollView, Image, Text, View, StyleSheet} from 'react-native';
  ...
  render() {
    return (
      ...
      <View style={styles.container}>
        ...
        <Text style={{ marginLeft: 20, fontSize: 16, fontFamily: 'poppins_medium', color: '#a2a4a8'  }}>Sangie</Text>
        </View>
        ...
        <Text style={{ marginLeft: 20, fontSize: 16, fontFamily: 'poppins_medium', color: '#a2a4a8'  }}>Malinga</Text>
        </View>
        ...
        <Text style={{ marginLeft: 20, fontSize: 16, fontFamily: 'poppins_medium', color: '#a2a4a8'  }}>Jay jay</Text>
        </View>
        ...
        <Text style={{ marginLeft: 20, fontSize: 16, fontFamily: 'poppins_medium', color: '#a2a4a8'  }}>Makawa</Text>
        </View>
        ...
        <Text style={{ marginLeft: 20, fontSize: 16, fontFamily: 'poppins_medium', color: '#a2a4a8'  }}>Theo</Text>
        </View>
        ...
        <View><Text style={{ backgroundColor: '#23b08d', height: 25, paddingLeft: 8, paddingTop: 3, width: 25, alignSelf: 'center', alignContent: 'center', borderRadius: 25, color: '#FFF' }}>4</Text></View>
        </View>
        </View>
           ...
           <View style={{ flexDirection: 'row' }}>
            ...
            <View><Text style={styles.groupName}>Onesmus</Text>
              <View style={{ flexDirection: 'row', justifyContent: 'space-around', padding: 10 }}>
                <Icon name="checkmark-done-outline" size={25} color={COLORS.blue}/>
                <Text style={{marginLeft: 10, fontSize: 14, fontFamily: 'poppins_medium', color: '#a2a4a8' }}>Yeah l also noticed...</Text>
              </View>
          </View>
        </View>
        <View style={{alignContent: 'center', alignSelf: 'center' }}>
           <View><Text style={{ backgroundColor: '#23b08d', height: 25, paddingLeft: 8, paddingTop: 3, width: 25, alignSelf: 'center', alignContent: 'center', borderRadius: 25, color: '#FFF' }}>2</Text></View>
           </View>
        </View>
        ...
        <View style={{alignContent: 'center', alignSelf: 'center' }}>
            <View><Text style={{ backgroundColor: '#23b08d', height: 25, paddingLeft: 8, paddingTop: 3, width: 25, alignSelf: 'center', alignContent: 'center', borderRadius: 25, color: '#FFF' }}>1</Text></View>
            </View>
        </View>
        ...
        <View style={{alignContent: 'center', alignSelf: 'center' }}>
           <View><Text style={{ backgroundColor: '#23b08d', height: 25, paddingLeft: 8, paddingTop: 3, width: 25, alignSelf: 'center', alignContent: 'center', borderRadius: 25, color: '#FFF' }}>9</Text></View>
           </View>
        </View>
        ...
        <View><Text style={styles.groupName}>Guntolah</Text>
        <Text style={{margin: 10, fontSize: 14, fontFamily: 'poppins_medium', color: '#a2a4a8' }}>Hello fam :) will be dropping..</Text>
        </View>
        </View>
        <View style={{alignContent: 'center', alignSelf: 'center' }}>
        <View><Text style={{ backgroundColor: '#23b08d', height: 25, paddingLeft: 8, paddingTop: 3, width: 25, alignSelf: 'center', alignContent: 'center', borderRadius: 25, color: '#FFF' }}>3</Text></View>
        </View>
        </View>
